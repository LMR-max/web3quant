"""
协议层分析（DEX 交易量 / TVL / LP 行为）
- 优先 Dune
- 可选 The Graph（示例：Uniswap V3 / Sushi / Curve）
"""
...
class ProtocolAnalyzer:
    ...
    def __init__(
        ...
        *,
        ...
        self.logger = get_logger("onchain_protocol")
...
def main() -> None:
    ap = argparse.ArgumentParser(description="协议层分析")
    ...
    if args.dune_query:
        ...
        out_path = args.out or _default_out_path("protocol_dune")
        ...
        out_path = args.out or _default_out_path("protocol_graph")
    else:
